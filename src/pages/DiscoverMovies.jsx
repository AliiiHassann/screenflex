...
export const DiscoverMovies = () => {
  ...
  async function discover(page, sortBy, genre, releaseYear) {
    setIsLoading(true);
    fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&${sortBy}&include_adult=false&include_video=false&page=${page}&${releaseYear}${genre}&with_watch_monetization_types=flatrate`
    )
      .then((res) => res.json())
      ...
      <div className='container-fluid discover-padding'>
        <div className='row'>
          ...
          <div className='col-lg-10 col-md-10'>
            <div className='row discover-row gy-5 ms-2 me-2 justify-content-center '>
